                ...
                <div className="tb">
                    ...
                    <div className="td" id="i-links">
                        <div className="tb">
                            ...
                            <div className="td">
                                <a href="#" id="p-link">
                                    <img src="https://imagizer.imageshack.com/img921/3072/rqkhIb.jpg" alt="Profile" />
                                </a>
                            </div>
                        </div>
                    </div>
                ...
                <div className="tb">
                            ...
                            <div>
                                <div className="q-ad-c">
                                    <a href="#" className="q-ad">
                                        <img src="https://imagizer.imageshack.com/img923/1849/4TnLy1.png" alt="Did you know" />
                    ...
                    <div className="td" id="m-col">
                        ...
                        <div>
                            <div className="post">
                                <div className="tb">
                                    <a href="#" className="td p-p-pic"><img src="https://imagizer.imageshack.com/img923/2452/zifFKH.jpg" alt="Post pic" /></a>
                                ...
                                <a href="#" className="p-cnt-v">
                                    <img src="https://imagizer.imageshack.com/img923/8568/6LwtUa.jpg" alt="Content" />
                                </a>
                                <div>
                        ...
                        <div id="chat-bar">
                            ...
                            <div id="cts">
                                <div className="on-ct active">
                                    <a href="#"><img src="https://imagizer.imageshack.com/img924/4231/JnFicn.jpg" alt="Contact" /></a>
                                </div>
                                <div className="on-ct active">
                                    <a href="#"><img src="https://imagizer.imageshack.com/img923/332/1abR4H.png" alt="Contact" /></a>
                                </div>
                                <div className="on-ct">
                                    <a href="#"><img src="https://imagizer.imageshack.com/img924/4231/JnFicn.jpg" alt="Contact" /></a>
                                </div>
